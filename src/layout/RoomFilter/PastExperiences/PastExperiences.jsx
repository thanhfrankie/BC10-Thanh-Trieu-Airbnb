...
const PastExperiences = () => {
  ...
  return (
    <div>
      ...
      <div className="w-full flex flex-col gap-3 items-center justify-start  py-2">
        <div className="flex gap-4 flex-wrap">
          {listLocationArr &&
            listLocationArr.map((location) => (
              <div
                key={location.id}
                className="RoomCard sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 mb-4  rounded-lg hover:shadow-lg  transition duration-300 ease-in-out"
              >
